        ...
        if user_id in states:
            ...
            if current_state == 'register_first_name':
                if not is_valid_length(text):
                    bot.send_message(user_id,
                                     f'Имя слишком длинное. Пожалуйста, введите не более {MAX_LENGTH} символов.')
                    return
                ...
                if not is_valid_length(text):
                    bot.send_message(user_id,
                                     f'Фамилия слишком длинная. Пожалуйста, введите не более {MAX_LENGTH} символов.')
                ...
                if not is_valid_length(text):
                    bot.send_message(user_id,
                                     f'Отчество слишком длинное. Пожалуйста, введите не более {MAX_LENGTH} символов.')
                ...
                if not is_valid_phone_number(text):
                    bot.send_message(user_id,
                                     "Номер телефона должен содержать только 11 цифр. Пожалуйста, введите корректный номер телефона.")
